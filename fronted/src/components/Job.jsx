...
const Job = ({ job }) => {
    ...
    return (
        <div className="w-full max-w-full p-4 px-8 bg-white border border-gray-100 rounded-md shadow-xl sm:p-6 md:p-5">
            ...
            <div className="flex items-center gap-3 my-3">
                ...
                <div className="flex flex-col">
                    <h1 className="text-base font-medium sm:text-lg">{job?.company?.name}</h1>
                    <p className="text-sm text-gray-500">India</p>
                </div>
            </div>
            ...
            {/* Buttons Row */}
            <div className="flex flex-col items-stretch gap-3 mt-5 sm:flex-row sm:items-center">
